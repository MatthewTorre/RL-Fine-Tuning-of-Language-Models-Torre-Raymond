...
save_dir="${SAVE_DIR:-/vol/checkpoints/extension_checkpoints}"

wandb_name="${WANDB_NAME:-extension_elo_lr${curr_lr}_bs${batch_size}_gs${group_size}_ent${entropy_coefficient}_kl${kl_divergence_coefficient}_lr${lr_schedule}_warmup${warmup_ratio}_temp${temperature}_topp${top_p}_topk${top_k}}"
